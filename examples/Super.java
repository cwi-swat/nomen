...
public interface Super<$O extends Super<$O>> 
  ...
  abstract class Foo<$O extends Super<$O>> extends Fib.Fact<$O> implements Super<$O> {
  ...
  abstract class Bar<$O extends Super<$O>> extends Super.Foo<$O> implements Super<$O> {
  ...
  abstract class Main<$O extends Super<$O>> extends nomen.lang.Kernel.Obj<$O> implements Super<$O> {

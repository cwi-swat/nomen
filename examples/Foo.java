...
public interface Foo<$O extends Foo<$O>> 
  ...
  abstract class Fact<$O extends Foo<$O>> extends nomen.lang.Kernel.Obj<$O> implements Foo<$O> {
  ...
  abstract class MyFact<$O extends Foo<$O>> extends Fib.Fact<$O> implements Foo<$O> {
  ...
  abstract class Main<$O extends Foo<$O>> extends nomen.lang.Kernel.Obj<$O> implements Foo<$O> {
  ...
  public $O main($O args) {
    ...
    class $Fib$Main2 extends Fib.Main2<$Self> implements $Self { } 
